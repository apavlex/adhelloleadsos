...
/**
 * @param {'google'|'facebook'|'instagram'|'twitter'|'linkedin'|'tiktok'} platform
 * @param {string} href
 * @param {{ stopPropagation?: boolean, gradId?: string }} [opts]
 */
...
/**
 * @param {{ gm?: string, fb?: string, ig?: string, tw?: string, li?: string, tt?: string, gradSuffix?: string }} links
 */
